...
function load(ids){
    ...
    if(!pids){
        if(!ids){
            ...
            prefix="/common/product/jumpAdd/"+id;
        }
    }else{
        ids=pids+ids;
        prefix="/common/product/jumpAdd/"+ids;
    }
...
function update() {
	...
	$.ajax({
		cache : true,
		type : "POST",
		url : "/common/expressDelivery/update/"+ids,
